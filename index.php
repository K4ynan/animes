...
<section id="pagina-home">
    <header>
        <img src="imagens/logo (1).png" class="logo" alt="logo">
    <nav class="menu-principal">
        <ul>
            <li><a href="mailto:kaynancamilo12@gamil.com" class="link-ativo">contato</a></li>
        </ul>
    </nav>
    </header>
    <main>
        <h1>AVENTURA E AÇÂO</h1>
        <div>
            <a href="#" class="btn">ASSISTIR AO VÌDEO</a>
            ...
            <div class="cadastro">
                <div class="col-12 col-sm2 col-md-6 col-lg-6 mt-2">
                    <div class="card" style="height:100%">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Título do anime </label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="qtd" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="Qtd total de episódios">
                            </div>
                            <div class="mb-3">
